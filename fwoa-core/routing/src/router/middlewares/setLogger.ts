...
import { captureFhirUserParts, capturePathParts, capturePathParametersProxyParts } from '../../regExpressions';
...
export const setLoggerMiddleware = async (req: express.Request, res: express.Response, next: express.NextFunction) => {
    try {
        ...
        let loggerDesign: setEntireLogger = {
            ...
            what: {
                userIdentity: (({ scopes, usableScopes }) => ({ scopes, usableScopes }))(response.locals.userIdentity),
